  ...
  return (
    <div className="w-full mx-auto scrollbar-hide ">
      ...
      <div className="relative">
        ...
        <div 
          ref={carouselRef}
          className="flex overflow-x-auto scrollbar-hide gap-4 px-4 md:px-8 pb-4"
          style={{ 
            scrollbarWidth: 'none', 
        ...
        >
          {cards.map((card) => (
            ...
            >
              <div className="relative w-[216px] h-[288px] rounded-md overflow-hidden transition-transform duration-300 group-hover:scale-105">
