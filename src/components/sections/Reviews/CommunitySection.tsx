...
export default function CommunitySection() {
  ...
  return (
    <section className="py-10 md:py-10 px-5 md:px-10 bg-black overflow-hidden border-t border-[#19181f]">
      <div className="container flex flex-col w-full items-start justify-left gap-10">
        ...
        <div className="relative w-full">
          ...
          {/* Second Row - Reversed Direction */}
            ...
            <h2 className="text-2xl md:text-5xl font-bold text-white py-10 md:py-20 mb-2">
              Trusted by
            </h2>
            <h2 className="h-full text-4xl md:text-[200px] lg:text-[270px] font-bold text-gray-800 py-10 mb-4">
              2,000,000+
            </h2>
        </div>
      </div>
